...
import { AdditionalQualificationState, DocumentRowState } from "@/app/(full-page)/pharmacy/fresh-registration/registrationState";
import { validateEducation, validateEducationDocuments, validateAdditionalQualifications } from "@/app/(full-page)/pharmacy/fresh-registration/validators";
...
import EducationSscHscSection from "@/app/(full-page)/pharmacy/fresh-registration/forms/EducationSscHscSection";
import EducationQualificationSection from "@/app/(full-page)/pharmacy/fresh-registration/forms/EducationQualificationSection";
import EducationAdditionalSection from "@/app/(full-page)/pharmacy/fresh-registration/forms/EducationAdditionalSection";
import EducationDetailsFooter from "@/app/(full-page)/pharmacy/fresh-registration/forms/EducationDetailsFooter";
