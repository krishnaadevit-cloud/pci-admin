...
import { REGISTRATION_STEPS } from "@/app/(full-page)/pharmacy/fresh-registration/constants";
...
import ApplicationPreview from "@/app/(full-page)/pharmacy/fresh-registration/ApplicationPreview";
import PaymentConfirmDialog from "@/app/(full-page)/pharmacy/fresh-registration/PaymentConfirmDialog";
import {
  canNavigateToStep,
  getFirstValidationMessage,
  validateRegistrationStep,
} from "@/app/(full-page)/pharmacy/fresh-registration/stepValidation";
import { useRouter } from 'next/navigation';
import { registrationToSerializablePayload } from "@/app/(full-page)/pharmacy/fresh-registration/registrationState";
...
interface PrtsRegistrationFlowProps {
  applicationTypeName?: string;
}

export default function PrtsRegistrationFlow({ applicationTypeName = "Fresh Registration Other State" }: PrtsRegistrationFlowProps) {
  ...
  const handlePaymentConfirm = useCallback(() => {
    ...
    console.log("Fresh registration (other state) API body:", body);
