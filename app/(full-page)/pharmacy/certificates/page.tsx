...
function downloadBodyTemplate(row: { downloadUrl?: string }) {
  if (!row.downloadUrl) return <span>—</span>;
  return (
    <a
    ...
    >
      <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clip-path="url(#clip0_20008415_46929)">
        ...
        <defs>
          <clipPath id="clip0_20008415_46929">
...
const COLUMNS: PageTableColumn[] = [
  { field: "srNo", header: "Sr No.", width: "6%" },
  { field: "issueDate", header: "Issue Date", width: "10%" },
  { field: "applicationName", header: "Certificate Name", width: "50%" },
  { field: "downloadUrl", header: "Download", width: "18%", body: downloadBodyTemplate },
];
...
export default function CertificatesPage() {
  ...
  const rawList = useAppSelector(selectCertificateList);
  const isLoading = useAppSelector(selectCertificateListLoading);
  ...
  useEffect(() => {
    dispatch(fetchCertificateListData());
  }, [dispatch]);
