...
interface CommunicationPermanentAddressProps {
  data: AddressState;
  errors?: AddressFieldErrors;
  onChange: (data: AddressState) => void;
}

export default function CommunicationPermanentAddress({
  data,
  errors,
  onChange,
}: CommunicationPermanentAddressProps) {
  ...
  return (
    <PrtsRegistrationAccordionSection title="Permanent Address">
