...
interface CommunicationCorrespondenceAddressProps {
  data: AddressState;
  errors?: AddressFieldErrors;
  onChange: (data: AddressState) => void;
  onCopyFromPermanent: () => void;
}

export default function CommunicationCorrespondenceAddress({
  data,
  errors,
  onChange,
  onCopyFromPermanent,
}: CommunicationCorrespondenceAddressProps) {
