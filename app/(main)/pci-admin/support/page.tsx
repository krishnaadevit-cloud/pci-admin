  ...
  return (
    <div className="super-admin-dashboard">
      ...
      <div className="dashboard-panel">
        ...
        <DataTable value={tickets} showGridlines filters={filters} onFilter={(e) => setFilters(e.filters as any)} globalFilterFields={['id', 'applicantName', 'category', 'state']} paginator rows={10} className="p-datatable-striped" responsiveLayout="scroll">
