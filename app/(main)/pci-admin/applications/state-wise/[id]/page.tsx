...
const StateApplicationsGrid = () => {
  ...
  let appsList = [];
  if (stateId === "all") {
    appsList = Object.entries(applicationsListMap)
  ...
  // Read status and type query param
  useEffect(() => {
    if (searchParams) {
  ...
  }, [statusFilter, typeFilter, appsList]);
      ...
      >
        ...
        >
          ...
          <span className="text-xl font-bold text-amber-600 mt-1 block">
            {stateId === "haryana"
              ? "450"
              : appsList.filter((a: any) => a.status === "Pending").length}
          </span>
        </div>
        <div
          className="p-3 text-center bg-white"
        ...
        >
          ...
          <span className="text-xl font-bold text-green-600 mt-1 block">
            {stateId === "haryana"
              ? "3,600"
              : appsList.filter((a: any) => a.status === "Approved").length}
          </span>
        </div>
        <div
          className="p-3 text-center bg-white"
        ...
        >
          ...
          <span className="text-xl font-bold text-red-600 mt-1 block">
            {stateId === "haryana"
              ? "220"
              : appsList.filter((a: any) => a.status === "Rejected").length}
          </span>
        </div>
        <div
          className="p-3 text-center bg-white"
        ...
        >
          ...
          <span className="text-xl font-bold text-blue-600 mt-1 block">
            {stateId === "haryana"
              ? "250"
              : appsList.filter((a: any) => a.status === "Returned").length}
          </span>
        </div>
      </div>
        ...
        {selectedApp && (
          ...
          >
            ...
            <div style={{ gridColumn: "span 2" }}>
              ...
              <Tag
                severity={getStatusSeverity(selectedApp.status)}
