    ...
    <div className="super-admin-dashboard">
        ...
        <div className="fal-page-header__inner">
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div className="fal-page-header__text">
              <h1 className="fal-page-header__title">Workflow Document Mapping</h1>
              <p className="fal-page-header__subtitle">Map and configure mandatory vs optional document upload checkers for each service workflow</p>
            </div>
          </div>
      ...
      <div className="dashboard-panel">
        ...
        <DataTable
          ...
          emptyMessage={<EmptyTableMessage message="No checklists mapped yet." />}
        ...
        >
          ...
          <Column 
            ...
            body={(row) => (
              <span className="fal-status fal-status--in_review">
                {row.mandatory}
              </span>
            )}
            style={{ width: '160px' }}
          ...
          <Column 
            ...
            body={(row: ApplicationMap) => (
              <div className="flex gap-2 justify-content-center">
                <Button icon="pi pi-pencil" className="fal-action-btn" onClick={() => editMap(row)} tooltip="Edit Mapping" tooltipOptions={{ position: 'bottom' }} />
                <Button icon="pi pi-refresh" className="fal-action-btn" onClick={() => syncMapping(row)} tooltip="Sync Councils" tooltipOptions={{ position: 'bottom' }} />
                <Button icon="pi pi-trash" className="fal-action-btn" style={{ color: '#ef4444' }} onClick={() => deleteMap(row)} tooltip="Delete Mapping" tooltipOptions={{ position: 'bottom' }} />
              </div>
            )}
            style={{ width: '140px' }}
          />
