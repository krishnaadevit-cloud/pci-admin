...
const ApplicationTypes = () => {
  ...
  const [appTypes, setAppTypes] = useState<ApplicationType[]>([
    {
      ...
      tat: 15,
      status: "Active",
      description: "Initial registration request for pharmacy graduates",
    },
    {
      code: "APP-RENEW",
      ...
      tat: 7,
      status: "Active",
      description: "Periodic registration renewal requests",
    },
    {
      code: "APP-ADDQ",
      ...
      tat: 10,
      status: "Active",
      description: "Adding postgraduate or higher degrees to current profile",
    },
    {
      code: "APP-DUPC",
      ...
      tat: 5,
      status: "Active",
      description: "Reissuing lost or damaged registration certificates",
    },
    {
      code: "APP-MIGR",
      ...
      status: "Active",
      description:
        "Transferring pharmacy registration registry to another state",
    },
    {
      code: "APP-NOC",
      ...
      tat: 12,
      status: "Active",
      description: "NOC verification request for other jurisdictions",
    },
    {
      code: "APP-GOOD",
      ...
      tat: 10,
      status: "Active",
      description: "Verification letter confirming ethical status",
    },
    {
      code: "APP-REST",
      name: "Restoration",
      ...
      tat: 14,
      status: "Inactive",
      description: "Restoring suspended or lapsed registrations",
    },
  ]);
  ...
  const saveType = () => {
    if (
      ...
      toast.current?.show({
        ...
        detail: "Please provide valid Code, Name, Fee, and SLA Limit.",
        life: 3000,
      });
      return;
    }
    ...
    if (dialogMode === "add") {
      ...
      if (
        appTypes.some(
          (t) => t.code.toUpperCase() === formType.code.toUpperCase(),
        )
      ) {
        toast.current?.show({
          severity: "error",
          summary: "Duplicate Code",
          detail: `Application Type Code '${formType.code}' already exists.`,
          life: 3000,
        });
        return;
      }
      setAppTypes([
        ...appTypes,
        { ...formType, code: formType.code.toUpperCase() },
      ]);
      toast.current?.show({
        severity: "success",
        summary: "Workflow Created",
        detail: `${formType.name} configured successfully.`,
        life: 3000,
      });
    } else {
      setAppTypes(
        appTypes.map((t) => (t.code === formType.code ? formType : t)),
      );
      toast.current?.show({
        severity: "info",
        summary: "Workflow Updated",
        detail: `${formType.name} configurations updated.`,
        life: 3000,
      });
    }
  ...
  const deleteType = (type: ApplicationType) => {
    ...
    toast.current?.show({
      ...
      detail: `${type.name} master registry removed.`,
      life: 3000,
    });
  };
  ...
  const configureSla = (type: ApplicationType) => {
    toast.current?.show({
      severity: "success",
      summary: "SLA Recalibrated",
      detail: `Turnaround Time SLA guidelines for ${type.name} synchronized to all councils.`,
      life: 3000,
    });
  };
    ...
    <div className="super-admin-dashboard">
        ...
        <div className="fal-page-header__inner">
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            ...
            <div className="fal-page-header__text">
              <h1 className="fal-page-header__title">Application Types Master</h1>
              <p className="fal-page-header__subtitle">
                View, edit, configure fees, and turnaround times (TAT) limits for all service workflows
              </p>
            </div>
          </div>
      ...
      <div className="dashboard-panel">
        ...
        <DataTable
          ...
          emptyMessage={<EmptyTableMessage message="No application workflows found." />}
        ...
        >
          ...
          <Column
            ...
            header="Standard Fee"
            sortable
            body={(row) => `₹ ${row.fee.toLocaleString()}`}
          />
          <Column
            field="tat"
            header="TAT SLA Limit"
            sortable
            body={(row) => `${row.tat} Days`}
          />
            ...
            body={(row: ApplicationType) => (
              <div className="flex gap-2 justify-content-center">
                ...
                <Button
                  icon="pi pi-cog"
                  className="fal-action-btn"
                  onClick={() => configureSla(row)}
                  tooltip="Configure SLA"
                  tooltipOptions={{ position: "bottom" }}
                />
                <Button
                  icon="pi pi-trash"
        ...
        <div className="flex flex-column gap-3 mt-2">
          <div className="flex flex-column gap-1">
            ...
            <InputText
              ...
              onChange={(e) =>
                setFormType({ ...formType, code: e.target.value })
              }
              placeholder="e.g. APP-FRESH"
              style={{ borderRadius: "8px" }}
            />
          </div>
          ...
          <div className="flex flex-column gap-1">
            ...
            <InputText
              ...
              value={formType.name}
              onChange={(e) =>
                setFormType({ ...formType, name: e.target.value })
              }
              placeholder="e.g. Fresh Registration"
              style={{ borderRadius: "8px" }}
            />
          </div>
          ...
          >
            <div className="flex flex-column gap-1">
              ...
              <InputNumber
                ...
                value={formType.fee}
                onValueChange={(e) =>
                  setFormType({ ...formType, fee: e.value || 0 })
                }
                mode="currency"
                currency="INR"
                locale="en-IN"
            ...
            <div className="flex flex-column gap-1">
              ...
              <InputNumber
                ...
                value={formType.tat}
                onValueChange={(e) =>
                  setFormType({ ...formType, tat: e.value || 0 })
                }
                suffix=" Days"
                style={{ borderRadius: "8px" }}
              />
          ...
          <div className="flex flex-column gap-1">
            ...
            <InputText
              ...
              onChange={(e) =>
                setFormType({ ...formType, description: e.target.value })
              }
          ...
          <div className="flex flex-column gap-1">
            ...
            <Dropdown
              ...
              options={statuses}
              onChange={(e) => setFormType({ ...formType, status: e.value })}
              style={{ borderRadius: "8px" }}
            />
          </div>
        </div>
