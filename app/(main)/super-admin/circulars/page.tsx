  ...
  return (
    <div className="super-admin-dashboard">
      ...
      <div className="dashboard-panel">
        ...
        <DataTable value={circulars} filters={filters} onFilter={(e) => setFilters(e.filters as any)} globalFilterFields={['title', 'category']} paginator rows={10} className="p-datatable-striped" responsiveLayout="scroll">
