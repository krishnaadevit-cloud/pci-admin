  ...
  return (
    <div className="super-admin-dashboard">
      ...
      <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center gap-3 dashboard-header">
        <div>
          <h2 className="header-title">Documents Registry Master</h2>
          <p className="header-subtitle">View, configure, update upload parameters, size limits, and categories for required documents</p>
        </div>
      </div>
          ...
          <Column 
            ...
            body={(row: DocumentType) => (
              <div className="flex gap-1">
                <Button icon="pi pi-pencil" className="p-button-rounded p-button-text p-button-sm" onClick={() => editDoc(row)} tooltip="Edit Parameters" tooltipOptions={{ position: 'bottom' }} />
                <Button icon="pi pi-shield" className="p-button-rounded p-button-text p-button-sm" onClick={() => configureVerification(row)} tooltip="Configure OCR & Verification" tooltipOptions={{ position: 'bottom' }} />
                <Button icon="pi pi-trash" className="p-button-rounded p-button-text p-button-danger p-button-sm" onClick={() => deleteDoc(row)} tooltip="Remove Document" tooltipOptions={{ position: 'bottom' }} />
              </div>
            )}
          />
        </DataTable>
